...
public:
    ...
    void MetrepolisSampling(int N_spins, int MC_cycles, double Temperature, arma::vec &ExpectationValues);
    void RunSystem(int MC_cycles, int N_spins, double initial_temp, double final_temp, double temp_step);
