...
public:
    ...
    void MetropolisSampling(int MC_cycles, double Temperature, arma::vec &ExpectationValues, int rankProcess, int NProcesses);
    ...
    void output(std::string filename, std::ofstream &file,  int MC_cycles, double temperature, arma::vec expectationValues);
    //int calculateEnergy(int N_spins);
    void intermediate_output(int cycles, double temp, arma::vec expectationValues, int MC_cycles, int rankProcess);
